<h1 class="panel">About Us</h1>
<br><br>
<section class="floatL">
    <div>
        <h3 class="panel">General</h3>
        <img src="<?php echo base_url(); ?>assets/themes/default/images/airboat_img2.jpg" class="floatR col-md-offset-1" alt="About Us - Airboat image 1"/>
        <p>
...
<section class="floatL">
    <div>
        <h3 class="panel">Flexible Hull</h3>
        <img src="<?php echo base_url(); ?>assets/themes/default/images/airboat_img2.jpg" class="floatR col-md-offset-1" alt="About Us - Airboat image 1"/>
        <p>
...
<section class="floatL">
    <div>
        <h3 class="panel">Transporting</h3>
        <img src="<?php echo base_url(); ?>assets/themes/default/images/airboat_img2.jpg" class="floatR col-md-offset-1" alt="About Us - Airboat image 1"/>
        <p>
...
<section class="floatL">
    <div>
        <h3 class="panel">Applications</h3>
        <img src="<?php echo base_url(); ?>assets/themes/default/images/airboat_img2.jpg" class="floatR col-md-offset-1" alt="About Us - Airboat image 1"/>
        <p>
...
<section class="floatL">
    <div>
        <h3 class="panel">Load Capacity and Speed</h3>
        <img src="<?php echo base_url(); ?>assets/themes/default/images/airboat_img2.jpg" class="floatR col-md-offset-1" alt="About Us - Airboat image 1"/>
        <p>
